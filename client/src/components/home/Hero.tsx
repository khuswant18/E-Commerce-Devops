    ...
    <section className="relative w-full min-h-[80vh] bg-slate-50 overflow-hidden flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="max-w-2xl pt-10 md:pt-0 pb-16 md:pb-0">
          ...
          >
            Your ultimate destination for the latest fashion trends. High-quality materials, sustainable production, and styles designed just for you.
          </motion.p>
          ...
          >
            <Link href="/shop">
              <Button size="lg" className="h-14 px-8 text-base rounded-full bg-slate-900 hover:bg-slate-800 text-white shadow-xl shadow-slate-900/20 group">
                Shop Now
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-slate-500 font-semibold uppercase tracking-wider">Trending</p>
