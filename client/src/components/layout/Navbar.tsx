        ...
        <div className="flex items-center gap-6">
          <Link href="/">
            <div className="w-12 h-12 rounded-2xl overflow-hidden brand-gradient flex items-center justify-center cursor-pointer hover:scale-105 transition-transform duration-300 shadow-md">
              <Image src={logo} alt="NOVA STREET" layout="fullWidth" className="w-full h-full object-cover" background="auto" />
            </div>
          </Link>

          <Link href="/">
            <span className="hidden sm:inline-block font-semibold tracking-[0.18em] text-sm text-slate-800 cursor-pointer">NOVA STREET</span>
          </Link>
                  ...
                  <>
                    <div className="px-4 pb-2">
                      ...
                      <div className="mt-3 space-y-2">
                        ...
                        <Link href="/register">
                          <div className="text-center brand-gradient text-white rounded-md py-2 cursor-pointer hover:opacity-95 font-bold text-sm">SIGN UP</div>
                        </Link>
                      </div>
                    </div>
