    ...
    <div className="w-full space-y-6 pr-6">
      <Accordion type="single" collapsible defaultValue="availability" className="w-full">
        ...
        <AccordionItem value="availability" className="border-b-0 mb-4">
          <AccordionTrigger className="text-base font-bold hover:no-underline py-2">
            Availability
          </AccordionTrigger>
          <AccordionContent>
          ...
          <AccordionContent>
            <div className="pt-4 px-1 pb-6 space-y-6">
              <div className="flex items-center justify-between gap-4">
                <div className="border border-gray-200 rounded px-3 py-2 w-full text-center text-sm">
                  ₹ {priceRange[0]}
                </div>
