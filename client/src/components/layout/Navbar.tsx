        ...
        <div className="flex items-center gap-4 md:gap-6">
          <div className="hidden md:flex relative w-64">
            ...
            <Input
              ...
              className="pl-10 h-10 bg-slate-50 border-transparent hover:bg-slate-100 focus:bg-white focus:border-slate-200 rounded-full transition-all duration-300"
            />
          </div>
          ...
          <div className="relative">
            ...
            {openUserMenu && (
              <div className="absolute right-0 top-full mt-2 w-56 bg-white border border-slate-100 rounded-xl shadow-lg z-50 py-3">
                {isAuthenticated ? (
                  <>
                    ...
                    <div className="px-2">
                      ...
                      <Link href="/wishlist" className="block px-3 py-2 rounded hover:bg-gray-50">
                        Wishlist
                      </Link>
                      <button
                  ...
                  <>
                    <div className="px-4 pb-2">
                      ...
                      <div className="mt-3 space-y-2">
                        <Link href="/login">
                          <div className="text-center border rounded-md py-2 cursor-pointer hover:bg-gray-50 font-bold text-sm">
                            LOGIN
                          </div>
                        </Link>
                        <Link href="/register">
                          <div className="text-center brand-gradient text-white rounded-md py-2 cursor-pointer hover:opacity-95 font-bold text-sm">
                            SIGN UP
                          </div>
                        </Link>
                      </div>
                    ...
                    <div className="px-2">
                      ...
                      <Link href="/contact" className="block px-3 py-2 rounded hover:bg-gray-50">
                        Contact Us
                      </Link>
                    </div>
                  </>
          ...
          <Link href="/wishlist" className="hover:text-gray-600 transition-colors relative group">
            ...
            {wishlistCount > 0 && (
              <span className="absolute -top-2 -right-2 brand-gradient text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center">
