    ...
    <div className="min-h-screen bg-white font-sans text-gray-900">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-full brand-gradient flex items-center justify-center shrink-0 shadow-sm">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-10">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Trending Picks</h2>
              <p className="text-slate-500 mt-2">Community favorites this week</p>
            </div>
            <Link href="/shop">
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Join the NOVA Community</h2>
